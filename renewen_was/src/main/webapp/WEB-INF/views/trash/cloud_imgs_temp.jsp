		...
		<div id="layoutSidenav_content">
			<main>
				...
				<div class="container-xl px-4 mt-5">
					...
					<div
						...
						<div class="me-4 mb-3 mb-sm-0">
							<h1 class="mb-0">Test1</h1>
							<div class="small">
								<span class="fw-500 text-primary">Friday</span> &middot;
								September 20, 2021 &middot; 12:16 PM
							</div>
						</div>
					</div>
				</div>
				<div>
					<h2>Cloud Imgs</h2>
					<p></p>
					<c:forEach var="cloud" items="${cloudImgs}">
						<img src="data:image/jpeg;base64,${cloud.base64String}"
							alt="${cloud.cloudImgDesc}" width="200px" height="200px">
