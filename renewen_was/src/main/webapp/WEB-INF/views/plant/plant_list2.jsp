...
<body class="nav-fixed">
												...
												<tr>
													...
													<td>
														...
														class="btn btn-datatable btn-icon btn-transparent-dark me-2"><i
															data-feather="more-vertical"></i></a> <!-- <button  class="btn btn-datatable btn-icon btn-transparent-dark"><i data-feather="trash-2"></i></button> -->
														<a
														href="${contextPath}/plant/list/delete?plantNo=${vo.plantNo}"
	...
	<!-- ncpClientId=l8y7kfobe4  /  vjk209bpi5 -->
	<script type="text/javascript"
	...
	function getAddressCoordinates(address) {
        ...
        geocoder.addressSearch(address, function(result, status) {
            if (status == daum.maps.services.Status.OK) {
                ...
                console.error("Failed to find coordinates for the address.");
            }
        });
    }
    
    document.getElementById("plantAddr").addEventListener("input", function() {
        var address = document.getElementById("plantAddr").value;
