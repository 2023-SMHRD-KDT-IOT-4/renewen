      	...
      	<!-- Main page content-->
	        ...
	        <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
	          <div class="me-4 mb-3 mb-sm-0">
	            <h1 class="mb-0">Plant Register</h1>
	            <div class="small">
        ...
        <div class="container mt-3">
				  ...
				  <form action="${contextPath}/plant/register" method="post">
				    <div class="mb-3 mt-3">
				      ...
				      <input type="text" class="form-control" id="plantName" placeholder="Enter id" name="plantName">
				    </div>
				    <div class="mb-3">
				      <label for="userPw">발전소 셀 갯수</label>
				      <input type="number" class="form-control" id="generateCellCnt" placeholder="Enter password" name="generateCellCnt">
				    </div>
